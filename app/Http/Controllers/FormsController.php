...
class FormsController extends Controller
{
        ...
        if ($formIds) {
            ...
            foreach ($allForms as $form) {
                ...
                $forms[] = [
                    ...
                    'preview_url'     => site_url('?fluentform_pages=1&design_mode=1&preview_id=' . $form->id)
                ];
            }
        }
    ...
    public function create(Request $request)
    {
        ...
        if ($form['double_optin']) {
            $defaultSettings['confirmation']['messageToShow'] = 'Please check your inbox to confirm your subscription';
        } else {
            $defaultSettings['confirmation']['messageToShow'] = 'You are successfully subscribed to our email list';
        }
        wpFluent()->table('fluentform_form_meta')
            ->insert(array(
                'form_id'  => $formId,
        ...
        return [
            ...
            'created_form' => [
                ...
                'preview_url' => site_url('?fluentform_pages=1&design_mode=1&preview_id=' . $formId)
            ]
        ];
    }
