...
class TransStrings
{
    ...
    public static function getStrings()
    {
        return [
            ...
            'Will be applied to the contacts who does not have any mapped tags in' => __('Will be applied to the contacts who does not have any mapped tags in', 'fluent-crm'),
            ...
            'Something is wrong when importing. Please check the error message below' => __('Something is wrong when importing. Please check the error message below', 'fluent-crm'),
            ...
            'Are you sure you want to add contacts to selected email sequence?' => __('Are you sure you want to add contacts to selected email sequence?', 'fluent-crm'),
            'Select Sequence' => __('Select Sequence', 'fluent-crm'),
            'Contacts already in the email sequence will be skipped' => __('Contacts already in the email sequence will be skipped', 'fluent-crm'),
            'Select Automation Funnel' => __('Select Automation Funnel', 'fluent-crm'),
            'Are you sure you want to add contacts to selected Automation Funnel?' => __('Are you sure you want to add contacts to selected Automation Funnel?', 'fluent-crm'),
            'Contacts already in the Automation will be skipped & only subscribed contacts will be attached' => __('Contacts already in the Automation will be skipped & only subscribed contacts will be attached', 'fluent-crm'),
            'Contact has been added manually to this automation funnel' => __('Contact has been added manually to this automation funnel', 'fluent-crm'),
