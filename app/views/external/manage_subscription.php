...
<head>
    ...
    <title><?php esc_html_e('Update your preferences', 'fluentcrm') ?></title>
    <?php
        wp_head();
...
<div class="fluentcrm_unsubscribe_wrapper">
    ...
    <div class="fluentcrm_un_form_wrapper">
        <h3><?php _e('Update your preferences', 'fluentcrm'); ?></h3>
        <form id="fluentcrm_preferences_form" class="fluentcrm_public_pref_form">
            ...
            <div class="fluentcrm_form_item">
                <label for="fc_email"><?php _e('Your Email Address', 'fluentcrm'); ?></label>
            ...
            <div class="fluentcrm_form_item">
                <label for="fc_first_name"><?php _e('First Name', 'fluentcrm'); ?></label>
            ...
            <div class="fluentcrm_form_item">
                <label for="fc_last_name"><?php _e('Last Name', 'fluentcrm'); ?></label>
            ...
            <?php if($list_options): ?>
            <div class="fluentcrm_form_item">
                <h4 class="mainling_list_group_title"><?php _e('Mailing List Groups', 'fluentcrm') ?></h4>
            ...
            <?php endif; ?>
            <div class="fluentcrm_form_item">
                <input id="fluentcrm_preferences_submit" type="submit" value="<?php _e('Update Profile', 'fluentcrm'); ?>"></input>
            </div>
