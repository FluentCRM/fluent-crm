...
use FluentCrm\Framework\Support\QueueableEntity;
...
abstract class Model implements ArrayAccess, ArrayableInterface, JsonableInterface, JsonSerializable, QueueableEntity, UrlRoutable
{
	 ...
	 *
	 * @var \FluentCrm\Framework\Foundation\Dispatcher
	 */
    ...
    protected function getRelationshipFromMethod($method)
    {
        ...
        if (! $relations instanceof Relation) {
            throw new LogicException('Relationship method must return an object of type '
                .'FluentCrm\Framework\Database\Orm\Relations\Relation');
        }
     ...
     *
     * @return \FluentCrm\Framework\Database\Connection
     */
     ...
     *
     * @return \FluentCrm\Framework\Contracts\Events\Dispatcher
     */
     ...
     *
     * @param  \FluentCrm\Framework\Foundation\Dispatcher  $dispatcher
     * @return void
     */
